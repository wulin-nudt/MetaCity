...
net.addStation(**{'type': 'mp', 'name': 'mp0', 'location': ['28.19447524943341,112.9771220671689', '28.198046870281217,112.97198996395964'], 'position': '441,-617,0', 'ip': '10.0.0.1/8', 'ip6': '2001:0:0:0:0:0:0:1/64', 'mac': '00:00:00:00:00:01', 'range': 500, 'speed': 20, 'dimage': 'ubuntu:test2', 'sysctls': {'net.ipv6.conf.all.disable_ipv6': '0'}},cls=OSMDockerStaion)
net.OSM_Mobility_For_ConfigurationData(**{'NodeMobilityConfig': {'speed': 20, 'coord': ['442,-610,0', '492,-484,0', '500,-443,0', '514,-385,0', '453,-366,0', '375,-354,0', '283,-339,0', '269,-338,0', '178,-336,0', '86,-339,0', '88,-304,0', '94,-184,0', '94,-183,0', '84,-184,0', '60,-184,0', '41,-183,0', '-56,-180,0'], 'distance': 976.1293994536938}, 'node': 'mp0'})
...
net.addAccessPoint(**{'type': 'bs', 'name': 'bs0', 'location': '28.19816983187203,112.97034851509135', 'position': '-223,-206,0', 'ssid': 'ssid-bs0', 'ip': '10.0.0.3/8', 'ip6': '2001:0:0:0:0:0:0:3/64', 'mac': '00:00:00:00:00:03', 'range': 500, 'failMode': 'secure'})
net.addAccessPoint(**{'type': 'bs', 'name': 'bs1', 'location': '28.197621232912816,112.97896343954396', 'position': '621,-267,0', 'ssid': 'ssid-bs1', 'ip': '10.0.0.4/8', 'ip6': '2001:0:0:0:0:0:0:4/64', 'mac': '00:00:00:00:00:04', 'range': 500, 'failMode': 'secure'})
...
net.addAccessPoint(**{'type': 'ap', 'name': 'ap2', 'location': '28.204318197480337,112.97739025881245', 'position': '467,477,0', 'ssid': 'ssid-ap2', 'ip': '10.0.0.7/8', 'ip6': '2001:0:0:0:0:0:0:7/64', 'mac': '00:00:00:00:00:07', 'range': 10, 'failMode': 'secure'})
...
net.startController(**{'controller': 'Controller', 'name': 'c', 'number': 1, 'ip': '127.0.0.1', 'port': 6653, 'protocol': 'tcp', 'app': 'simple_switch'})
...
net.start()
thread_list = []
t=NetworkDelayMonitor('mp0', 'ec2', net, monitor_type= {'delay'}).start(data_storage_Directory='/home/kylin/Desktop/PythonProject/OSM_Mininet_WIFI/Mininet_WIFI/Network_Topology/Network_Topology_20230312145821597557.json',**{'period': 60}).thread_
thread_list.append(t)
for td in thread_list: td.join()
net.OSM_Experiment_Ended(data_storage_Directory='/home/kylin/Desktop/PythonProject/OSM_Mininet_WIFI/Mininet_WIFI/Network_Topology/Network_Topology_20230312145821597557.json')
net.stop()
