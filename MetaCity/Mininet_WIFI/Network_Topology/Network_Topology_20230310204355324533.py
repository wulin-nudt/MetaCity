...
setLogLevel('info')
net = OSM_Mininet_wifi(controller=Controller,autoAssociation=True)
...
net.addLink(**{'type': 'nl', 'node1': 'ap2', 'node2': 'bs1', 'delay': '40ms', 'bw': 20, 'jitter': '5ms', 'loss': 10})
net.addLink(**{'type': 'nl', 'node1': 'ap2', 'node2': 'bs0', 'delay': '80ms', 'bw': 10, 'jitter': '10ms', 'loss': 5})
...
net.start()
thread_list = []
t=NetworkDelayMonitor('mp0', 'ec2', net, monitor_type= {'delay', 'packet_loss'}).start(data_storage_Directory='/home/kylin/Desktop/PythonProject/OSM_Mininet_WIFI/Mininet_WIFI/Network_Topology/Network_Topology_20230310204355324533.json',**{'period': 100}).thread_
thread_list.append(t)
for td in thread_list: td.join()
net.OSM_Experiment_Ended(data_storage_Directory='/home/kylin/Desktop/PythonProject/OSM_Mininet_WIFI/Mininet_WIFI/Network_Topology/Network_Topology_20230310204355324533.json')
net.stop()
